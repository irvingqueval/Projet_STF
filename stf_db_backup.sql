...
INSERT INTO `discovery_pack_reservation` VALUES (1,2,2,'2024-08-29','17:31:00'),(2,2,2,'2024-08-28','13:39:00'),(3,2,2,'2024-09-03','18:44:00'),(4,2,1,'2024-08-06','16:47:00');
...
CREATE TABLE `weapon_reservation` (
  ...
  `date` date DEFAULT NULL,
  `hour` time DEFAULT NULL,
  `ammo_boxes` int DEFAULT '0',
  `total_price` decimal(10,2) NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `user_id` (`user_id`),
  KEY `weapon_reservation_ibfk_2` (`weapon_id`),
  CONSTRAINT `weapon_reservation_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`ID`),
  CONSTRAINT `weapon_reservation_ibfk_2` FOREIGN KEY (`weapon_id`) REFERENCES `weapon` (`ID`) ON DELETE SET NULL
...
INSERT INTO `weapon_reservation` VALUES (4,2,NULL,'2024-08-16','00:20:00',0,0.00),(5,2,NULL,'2024-08-16','11:30:00',0,0.00),(6,2,NULL,'2024-08-19','00:38:00',0,5.00),(7,2,3,'2024-08-23','03:43:00',0,5.00),(8,2,8,'2024-08-26','03:49:00',0,5.00),(9,2,2,'2024-08-16','01:53:00',0,5.00),(10,2,5,'2024-08-19','05:02:00',1,30.00),(11,2,2,'2024-08-14','02:17:00',1,22.00),(12,2,2,'2024-08-13','01:22:00',0,5.00),(13,2,9,'2024-08-27','02:27:00',0,5.00),(14,2,NULL,'2024-08-20','01:30:00',0,5.00),(15,2,2,'2024-08-07','01:35:00',3,56.00),(16,2,8,'2024-08-20','03:42:00',4,197.00),(17,3,NULL,'2024-08-19','14:11:00',2,39.00),(18,2,2,'2024-08-20','15:19:00',3,56.00),(19,2,2,'2024-08-19','15:29:00',0,5.00),(20,2,3,'2024-08-12','19:29:00',0,5.00),(21,2,2,'2024-08-13','13:33:00',0,5.00),(22,2,2,'2024-08-20','15:40:00',0,5.00),(23,2,2,'2024-07-29','15:46:00',3,56.00),(24,2,2,'2024-08-13','15:46:00',6,107.00),(25,2,2,'2024-08-07','18:47:00',1,22.00);
...
-- Dump completed on 2024-08-16 10:44:00
